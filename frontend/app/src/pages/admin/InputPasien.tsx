...
import {
  ...
  ChevronRight, ChevronLeft, Stethoscope, Send, RotateCcw, Check, Brain, CheckCircle
} from 'lucide-react'
...
export default function InputPasien() {
  ...
  const determinePriority = () => {
    // Simple priority determination based on symptoms and vital signs
    ...
    return (
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <Button variant="outline" onClick={() => navigate('/admin/antrian')} className="flex-1 gap-2">
            Lihat Antrian
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between mt-6">
        <Button variant="outline" onClick={() => step > 1 ? setStep(step - 1) : navigate('/admin')} className="gap-2">
