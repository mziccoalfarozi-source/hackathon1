  ...
  if (completedPatients.length === 0) {
    completedPatients = [
      ...
      },
      {
        ...
        prescriptions: [
          { medicationName: 'Amlodipine', dosage: '10mg', frequency: '1x sehari', duration: '30 hari' }
        ],
        pharmacyStatus: 'COMPLETED',
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">{completedPatients.length} resep telah diserahkan</p>
      </div>
