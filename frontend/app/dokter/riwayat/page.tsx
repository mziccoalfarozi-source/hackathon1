    ...
    completedPatients = [
      {
        ...
        gender: 'L',
        status: 'COMPLETED',
        triageResult: { priority: 'HIGH', confidence: 0.88, suggestedDepartment: 'Poli Dalam', aiReasoning: '' },
        queueNumber: 'A-005',
        symptoms: 'Nyeri dada',
        ...
        prescriptions: [
          { medicationName: 'Amlodipine', dosage: '5mg', instructions: '1x sehari' }
        ],
      ...
      },
      {
        ...
        gender: 'P',
        status: 'COMPLETED',
        triageResult: { priority: 'MEDIUM', confidence: 0.92, suggestedDepartment: 'Poli Umum', aiReasoning: '' },
        queueNumber: 'B-012',
        ...
        prescriptions: [
          { medicationName: 'Paracetamol', dosage: '500mg', instructions: '3x sehari' },
          { medicationName: 'Amoxicillin', dosage: '500mg', instructions: '3x sehari' }
        ],
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">{completedPatients.length} pasien telah diperiksa</p>
      </div>
      ...
      <StaggerContainer className="space-y-3">
        ...
        {completedPatients.length === 0 && (
          <SlideUp delay={0.2} className="text-center py-20">
            ...
            <p className="text-muted-foreground font-medium">Belum ada riwayat pasien</p>
          </SlideUp>
        )}
      </StaggerContainer>
    </div>
